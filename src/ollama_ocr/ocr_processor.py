...
class OCRProcessor:
    ...
    def process_image(self, image_path: str, prompt: str = "markdown", preprocess: bool = True) -> str:
        """
        ...
        try:
            ...
            prompts = {
                ...
                "table": """Please look at this image and extract text that appears as data in columns:
                - Look for column widths to ensure all data appears in the proper column
                - Look for column headings which might be useful for keeping data in the correct column
                - Look for data in rows and ensure that new line characters are treated as spaces when it is part of a single row
                - Interpret all pipe characters as exclamation points so that it doesn't break our pipe separted output
                - Present the data as pipe ("|") separated data"""
            }
